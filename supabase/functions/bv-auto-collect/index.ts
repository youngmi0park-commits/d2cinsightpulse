...
const ALL_LOCALES = [
  ...
  { locale: "pt_BR", region: "br", keyName: "BAZAARVOICE_BR_API_KEY" },
  { locale: "es_ES", region: "es", keyName: "BAZAARVOICE_ES_API_KEY" },
  { locale: "es_MX", region: "mx", keyName: "BAZAARVOICE_MX_API_KEY" },
