...
const COUNTRY_CONFIG: Record<string, { lang: string; searchTerms: string[] }> = {
  ...
  VN: { lang: "vi", searchTerms: [
    "LG TV đánh giá site:tinhte.vn",
    "LG OLED review site:voz.vn",
    "LG tủ lạnh đánh giá site:webtretho.com",
    "LG máy giặt review site:tinhte.vn",
    "LG máy lạnh đánh giá site:voz.vn",
    "LG soundbar đánh giá site:tinhte.vn",
    "LG OLED đánh giá site:shopee.vn",
    "LG tủ lạnh review site:lazada.vn",
    "LG TV đánh giá site:thegioididong.com",
    "LG máy giặt đánh giá site:dienmayxanh.com",
    "LG review site:nguyenkim.com",
    "LG đánh giá site:fptshop.com.vn",
  ] },
  ...
  CA: { lang: "en", searchTerms: [
    "LG TV review site:bestbuy.ca",
    "LG refrigerator review site:bestbuy.ca",
    "LG washer review site:bestbuy.ca",
    "LG OLED review site:redflagdeals.com",
    "LG appliance review site:redflagdeals.com",
    "LG TV avis site:bestbuy.ca",
    "LG review site:canadiantire.ca",
    "LG appliance review site:homedepot.ca",
    "LG TV review site:reddit.com/r/canada",
    "LG review site:thebrick.com",
    "LG appliance review site:lowes.ca",
    "LG review site:amazon.ca",
  ] },
