...
<tr><td style="padding:20px 32px;border-bottom:1px solid #F0ECE4;font-family:${FONT};">
  <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
    ...
    <tr><td style="font-size:12px;color:#6B6A6E;line-height:20px;font-weight:400;">${bi("RTA Studio는 19개국, 100+ 채널의 실사용자 리뷰를 통합 분석하여 숨겨진 인사이트를 발견하고, 즉시 활용 가능한 마케팅 에셋을 제공하는 올인원 플랫폼입니다.", "RTA Studio analyzes real user reviews across 19 countries and 100+ channels, surfacing hidden insights and producing ready-to-use marketing assets — all in one platform.")}</td></tr>
  </table>
</td></tr>
