  ...
  return [
    {
      ...
      messages: [
        ...
        },
        {
          ...
          icon: "📰",
          headline: `LG ${productName} Earns Strong User Praise for ${pros[0] || "Quality"}`,
          body: `ENGLEWOOD CLIFFS, N.J. — The LG ${productName} has been consistently praised by customers for ${pros.join(", ")}. ${cons.length > 0 ? `User feedback also identified areas for improvement, including ${cons.join(" and ")}, which LG continues to address.` : ""}\n\nNote: Insights reflect customer feedback and do not represent laboratory test results.`,
