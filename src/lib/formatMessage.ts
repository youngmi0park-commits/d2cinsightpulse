      ...
      messages: [
        {
          ...
          icon: "📱",
          headline: `[Ad] ${posPercent}% of ${total} verified reviews rate the ${productName} positively.`,
          body: `Based on analysis of ${total} user reviews from ${dataSrc}, key highlights include ${pros.join(", ")}. Satisfaction score: ${score}/100.`,
        ...
        },
        {
          ...
          icon: "🛒",
          headline: `${productName} — ${(averageScore * 5).toFixed(1)}/5 based on ${total.toLocaleString()} user reviews`,
          body: `Users frequently mention ${pros.join(" and ")} as strengths. ${cons.length > 0 ? `Some users noted areas for improvement: ${cons.join(" and ")}. LG is addressing feedback through ongoing updates.` : "User feedback is largely positive across review sources."}`,
        ...
        },
        {
          ...
          icon: "✉️",
          headline: `[LG Insider] ${productName} — ${posPercent}% positive across ${total} reviews`,
          body: `Hi [First Name],\n\nWe analyzed ${total} user reviews of the ${productName} from ${dataSrc}.\n\nSatisfaction Score: ${score}/100\nFrequently Praised: ${pros.join(", ") || "Overall quality"}\n\nSee what users are saying about their experience.`,
        ...
        },
        {
          ...
          icon: "📰",
          headline: `LG ${productName} Achieves ${score}/100 User Satisfaction Score Based on ${total} Reviews`,
          body: `ENGLEWOOD CLIFFS, N.J. — Based on analysis of ${total} user reviews collected from ${dataSrc} over the past 12 months, the LG ${productName} has achieved a user satisfaction score of ${score}/100. Frequently cited strengths include ${pros.join(", ")}. ${cons.length > 0 ? `User feedback also identified areas for improvement, including ${cons.join(" and ")}, which LG continues to address.` : ""}\n\nNote: Scores are derived from automated sentiment analysis of publicly available user-generated content and do not represent laboratory test results.`,
      ...
      messages: [
        {
          ...
          purposeLabel: "Social Media Ad",
          icon: "📱",
          headline: `[Ad] UK users give the ${productName} a ${score}/100 satisfaction score.`,
          body: `Based on ${total} user reviews, UK consumers highlight ${pros.join(", ")}. Available at Currys, Richer Sounds, and LG.com/UK.`,
        ...
        },
        {
          ...
          purposeLabel: "Product Page Copy",
          icon: "🛒",
          headline: `${productName} — Rated ${(averageScore * 5).toFixed(1)}/5 across ${total} user reviews`,
          body: `UK users frequently mention ${pros.join(" and ")}. ${cons.length > 0 ? `Some users noted ${cons.join(", ")}.` : ""} Review data from ${dataSrc}.`,
      ...
      messages: [
        {
          ...
          purposeLabel: "Social Media Ad",
          icon: "📱",
          headline: `[Ad] ${productName} scores ${score}/100 based on ${total} user reviews.`,
          body: `Canadian and North American user reviews highlight ${pros.join(", ")}. Review data sourced from ${dataSrc}.`,
        ...
        },
        {
          ...
          purposeLabel: "Product Page Copy",
          icon: "🛒",
          headline: `${productName} — ${posPercent}% positive feedback from ${total} user reviews`,
      ...
      messages: [
        {
          ...
          purposeLabel: "Social Media Ad",
          icon: "📱",
          headline: `[Ad] ${posPercent}% positive reviews for the ${productName} (${total} reviews analyzed).`,
          body: `Australian users highlight ${pros.join(", ")} in their reviews. Data sourced from ${dataSrc}. Available at JB Hi-Fi, Harvey Norman, and LG.com AU.`,
      ...
      messages: [
        {
          ...
          purposeLabel: "Social Media Ad",
          icon: "📱",
          headline: `[Anzeige] ${productName} — ${score}/100 Zufriedenheitswert basierend auf ${total} Nutzerbewertungen.`,
          body: `Nutzer heben ${pros.join(", ")} hervor. DVB-T2/SAT-Kompatibilität und EU-Garantie inklusive. Daten aus ${dataSrc}.`,
      ...
      messages: [
        {
          ...
          purposeLabel: "Social Media Ad",
          icon: "📱",
          headline: `[Ad] ${productName} receives ${score}/100 satisfaction score from ${total} user reviews.`,
          body: `Indian and global user reviews highlight ${pros.join(", ")}. Review data from ${dataSrc}.`,
      ...
      messages: [
        {
          ...
          purposeLabel: "Social Media Ad",
          icon: "📱",
          headline: `[Publicité] ${productName} — Score de satisfaction: ${score}/100 (${total} avis analysés).`,
          body: `Les utilisateurs mettent en avant ${pros.join(", ")}. Données issues de ${dataSrc}. Disponible chez Darty, Boulanger et LG.com/FR.`,
      ...
      messages: [
        {
          ...
          purposeLabel: "Social Media Ad",
          icon: "📱",
          headline: `[Anúncio] ${productName} — ${posPercent}% de avaliações positivas (${total} avaliações analisadas).`,
          body: `Usuários destacam ${pros.join(", ")}. Dados de ${dataSrc}. Qualidade OLED e estabilidade de streaming são pontos frequentes.`,
      ...
      messages: [
        {
          ...
          purposeLabel: "Social Media Ad",
          icon: "📱",
          headline: `[Advertentie] ${productName} — ${score}/100 tevredenheidsscore op basis van ${total} gebruikersrecensies.`,
          body: `Gebruikers waarderen ${pros.join(", ")}. Gegevens van ${dataSrc}. EU-energielabel en garantie van toepassing.`,
      ...
      messages: [
        {
          ...
          purposeLabel: "Social Media Ad",
          icon: "📱",
          headline: `[Publicidad] ${productName} — Puntuación ${score}/100 basada en ${total} reseñas de usuarios.`,
          body: `Los usuarios destacan ${pros.join(", ")}. Datos de ${dataSrc}. Garantía local disponible.`,
