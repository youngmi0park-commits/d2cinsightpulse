...
export const LGE_SUBSIDIARIES = [
  ...
  { code:"LGEIN", country:"인도",       countryEn:"India",          flag:"🇮🇳", region:"SouthAsia" },
  { code:"LGEAP", country:"호주",       countryEn:"Australia",      flag:"🇦🇺", region:"Oceania"   },
  { code:"LGEJP", country:"일본",       countryEn:"Japan",          flag:"🇯🇵", region:"NEAsia"    },
  { code:"LGETW", country:"대만",       countryEn:"Taiwan",         flag:"🇹🇼", region:"NEAsia"    },
  { code:"LGEHK", country:"홍콩",       countryEn:"Hong Kong",      flag:"🇭🇰", region:"NEAsia"    },
  { code:"LGESG", country:"싱가포르",   countryEn:"Singapore",      flag:"🇸🇬", region:"SEAsia"    },
  { code:"LGEMY", country:"말레이시아", countryEn:"Malaysia",       flag:"🇲🇾", region:"SEAsia"    },
  { code:"LGEID", country:"인도네시아", countryEn:"Indonesia",      flag:"🇮🇩", region:"SEAsia"    },
