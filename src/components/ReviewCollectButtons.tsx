...
const COLLECT_CHANNELS: ChannelDef[] = [
  ...
  },
  {
    ...
    label: "🔄 BV Auto (Full)",
    icon: Globe,
    description: "Auto sweep + collect + sync all 15 countries",
    descriptionKo: "15개국 전체 자동 스윕 + 수집 + 동기화",
  },
  {
    id: "bv_auto_sweep",
    label: "🔍 BV Auto Sweep",
    icon: Globe,
    description: "Auto sweep all 15 countries (register products only)",
    descriptionKo: "15개국 전체 제품 카탈로그 스캔",
  },
  {
    id: "reddit",
    label: "Reddit",
