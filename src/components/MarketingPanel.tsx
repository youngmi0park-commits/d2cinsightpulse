...
import { Copy, ThumbsUp, Lightbulb, Shield, Star, TrendingUp, AlertTriangle } from "lucide-react";
  ...
  return (
    <div className="gradient-card rounded-xl border border-border p-6 space-y-5">
      ...
      <p className="text-sm text-muted-foreground">
        {t(
          "Key insights extracted from real user reviews — satisfaction points, practical tips, and durability feedback at a glance.",
          "실사용자 리뷰에서 추출한 핵심 인사이트 — 만족 포인트, 실용적 사용팁, 내구성 피드백을 한눈에 확인하세요."
        )}
      </p>
