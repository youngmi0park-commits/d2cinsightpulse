...
const ALL_COUNTRIES: {
  ...
  // Americas & Europe
  { value: "US", label: "US", flag: "🇺🇸", nameKo: "미국", nameEn: "United States", group: "americas",
  ...
  { value: "UK", label: "UK", flag: "🇬🇧", nameKo: "영국", nameEn: "United Kingdom", group: "americas",
    sources: ["LG.com UK", "Amazon UK", "YouTube UK", "Trusted Reviews"] },
  { value: "CA", label: "CA", flag: "🇨🇦", nameKo: "캐나다", nameEn: "Canada", group: "americas",
    sources: ["Amazon CA", "YouTube CA"] },
  { value: "DE", label: "DE", flag: "🇩🇪", nameKo: "독일", nameEn: "Germany", group: "americas",
    sources: ["Amazon DE", "YouTube DE"] },
  { value: "FR", label: "FR", flag: "🇫🇷", nameKo: "프랑스", nameEn: "France", group: "americas",
    sources: ["Amazon FR", "YouTube FR"] },
  { value: "AU", label: "AU", flag: "🇦🇺", nameKo: "호주", nameEn: "Australia", group: "americas",
    sources: ["Amazon AU", "YouTube AU"] },
  { value: "BR", label: "BR", flag: "🇧🇷", nameKo: "브라질", nameEn: "Brazil", group: "americas",
    sources: ["Amazon BR", "YouTube BR"] },
  { value: "MX", label: "MX", flag: "🇲🇽", nameKo: "멕시코", nameEn: "Mexico", group: "americas",
    sources: ["Amazon MX", "YouTube MX"] },
  // Asia
  { value: "JP", label: "JP", flag: "🇯🇵", nameKo: "일본", nameEn: "Japan", group: "asia",
    sources: ["Amazon JP", "YouTube JP", "Reviews.io"] },
  { value: "SG", label: "SG", flag: "🇸🇬", nameKo: "싱가포르", nameEn: "Singapore", group: "asia",
    sources: ["Shopee SG", "Lazada SG", "YouTube SG"] },
  { value: "MY", label: "MY", flag: "🇲🇾", nameKo: "말레이시아", nameEn: "Malaysia", group: "asia",
    sources: ["Shopee MY", "Lazada MY", "YouTube MY"] },
  { value: "TH", label: "TH", flag: "🇹🇭", nameKo: "태국", nameEn: "Thailand", group: "asia",
    sources: ["Shopee TH", "Lazada TH", "YouTube TH"] },
  { value: "PH", label: "PH", flag: "🇵🇭", nameKo: "필리핀", nameEn: "Philippines", group: "asia",
    sources: ["Shopee PH", "Lazada PH", "YouTube PH"] },
  { value: "ID", label: "ID", flag: "🇮🇩", nameKo: "인도네시아", nameEn: "Indonesia", group: "asia",
    sources: ["Shopee ID", "Lazada ID", "YouTube ID"] },
  { value: "VN", label: "VN", flag: "🇻🇳", nameKo: "베트남", nameEn: "Vietnam", group: "asia",
    sources: ["Shopee VN", "Lazada VN", "YouTube VN"] },
  { value: "TW", label: "TW", flag: "🇹🇼", nameKo: "대만", nameEn: "Taiwan", group: "asia",
    sources: ["Amazon Global", "YouTube TW", "Reviews.io"] },
  { value: "HK", label: "HK", flag: "🇭🇰", nameKo: "홍콩", nameEn: "Hong Kong", group: "asia",
    sources: ["Amazon Global", "YouTube HK", "Reviews.io"] },
  { value: "IN", label: "IN", flag: "🇮🇳", nameKo: "인도", nameEn: "India", group: "asia",
