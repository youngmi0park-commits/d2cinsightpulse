        ...
        return (
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
            <div className="bg-background border border-border rounded-xl p-3.5 relative overflow-hidden">
              ...
              <p className="text-[10px] text-muted-foreground font-medium mb-1">이번주 수집 리뷰</p>
              <p className="text-3xl font-extrabold tracking-tight leading-none">{(wowData?.thisWeek ?? 0).toLocaleString()}</p>
              <p className={cn("text-[10px] font-semibold mt-1.5", weeklyDelta > 0 ? "text-green-700" : weeklyDelta < 0 ? "text-destructive" : "text-muted-foreground")}>
                {weeklyDelta > 0
              ...
              <p className="text-[10px] text-muted-foreground mt-2 pt-2 border-t border-border/60">
                누적 총 리뷰 <span className="font-semibold text-muted-foreground">{totalReviews.toLocaleString()}</span>
              </p>
