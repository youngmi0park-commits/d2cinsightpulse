import { MessageSquare, ShoppingCart, ThumbsUp, ThumbsDown, BarChart3, ArrowUpRight, ArrowDownRight, TrendingUp, TrendingDown, Minus, ExternalLink } from "lucide-react";
